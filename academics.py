...
# For example: Class Car and function Honda, Swift and according to their respective function object will  be called. 
# Function should have one argument 'SELF'
# Object is written as example: object = LOL() Important to have round braces. 
